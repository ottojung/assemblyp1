...
On `marceline-dev`, configure the execution environment according to [`lean-on-marceline-dev.md`](lean-on-marceline-dev.md) before running Lean/Lake commands or launching managed agents.
