...
- [`lean-on-marceline-dev.md`](lean-on-marceline-dev.md) — use Marceline Dev for Lean work, distinguish smoke-test Lean from the exact project toolchain, and avoid per-worktree duplication.
