...
- [`lean-on-marceline-dev.md`](lean-on-marceline-dev.md) — configure the existing Marceline Dev Lean/Elan toolchain and reuse shared Mathlib without per-worktree multi-gigabyte duplication.
