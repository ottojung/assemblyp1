...
its primitive/periodic repeat reduction, its conditional final wiring, and the
population division/Eulerian reduction plus thin tie-to-rotation wiring are
kernel-checked. External source-boundary and complete-spectrum uniqueness
premises are not claimed as kernel-checked.}
\end{table}
...
variable-length Section~6.2 statement; and (9) the population model for
molecule read types.
