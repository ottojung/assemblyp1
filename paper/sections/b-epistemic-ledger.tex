...
Primitivity plus P2 gives gcd-one spectra (division + Eulerian + BBT),
  ...
  & project mathematical reduction (formalization in progress) & issue \#70 \\
...
variable-length Section~6.2 statement; (9) completion of the kernel-checked
population gcd-one/division reduction and final population wiring; and
