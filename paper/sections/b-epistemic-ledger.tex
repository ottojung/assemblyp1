...
Same-length oriented Section~6.2 rigidity under $\Is$
  & mathematical fact & Theorem~\ref{thm:rigidity} \\
No strict same-length Section~6.2 counterexample, any $G,L,\Alphabet$
  & mathematical fact & Corollary~\ref{cor:same-length-zero} \\
...
Primitivity plus scaling reduces normalized to ordinary spectra
...
$AABBC\to AABC$ sampling failure, ratio $25/16$
  & verified computation & repository script \\
...
variable-length Section~6.2 statement; (9) a full proof of the scaling lemma;
