...
counterexample exists for any genome length, read length, or alphabet.
...
\input{sections/03-open-question}
\input{sections/04-finite-results}
\input{sections/05-population}
\input{sections/06-discussion}

\appendix
\input{sections/a-modeling-choices}
\input{sections/b-epistemic-ledger}
\input{sections/c-reproduction}
